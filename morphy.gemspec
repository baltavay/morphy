...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Morphological analyzer (POS tagger + inflection engine) for Russian language in ruby. Inspired by pymorphy2}
  ...
  spec.add_development_dependency "dawg"
end
